...
const FamilyMemberSubSchema = new Schema<IFamilyMember>(
  {
    relationType  : { type: String, enum: Object.values(RelationType), required: true },
...
const ChalanEntrySubSchema = new Schema<IChalanEntry>(
  {
    chalanDate          : { type: Date, required: true },
    sourceOfDonation    : { type: String, enum: Object.values(SourceOfDonation), required: true },
    currency            : { type: String, enum: Object.values(Currency), default: Currency.INR },
    amount              : { type: Number, required: true, min: 0 },
    modeOfPayment       : { type: String, enum: Object.values(ModeOfPayment), required: true },
...
const DonorSchema = new Schema<IDonor>(
  {
    profile : { type: ProfileSubSchema, required: true },
